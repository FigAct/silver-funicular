...
if __name__ == '__main__':
    os.makedirs('开个脑壳儿', exist_ok=True)
    ...
    for url in url_list:
        ...
        info = selector.xpath("string(/html/body/div[4]/div/div/div[2]/div[3])")   # 提取章节内容
        title = selector.xpath("/html/body/div[4]/div/div/div[2]/h1/text()")[0].replace(" ", "_")    # 提取题目
        path = '开个脑壳儿' + '//' + title + '.txt'  # 保存txt文件的文件名
